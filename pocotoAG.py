...
for mmm in [y for y in range(26+1,60+1) ]:
   df['F'+str(mmm)+'a']=np.log(1+df['f_odd_lay_'+str(mmm)+'m'])
   df['F'+str(mmm)+'b']=np.log(1+df['F'+str(mmm)+'a'])
   df['F'+str(mmm)+'c']=np.log(1+df['F'+str(mmm)+'b'])
